...
const stats = [
  { value: "30x", label: "Faster insights" },
  { value: "99%", label: "Query accuracy" },
  { value: "20x", label: "Time saved" },
];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-3 gap-8 mb-24 max-w-3xl mx-auto">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              <div className="text-4xl md:text-6xl font-bold text-foreground font-mono mb-2">{stat.value}</div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature) => (
            <div key={feature.title} className="bg-card border border-border rounded-lg p-8 hover:border-primary/30 transition-all duration-300 group">
